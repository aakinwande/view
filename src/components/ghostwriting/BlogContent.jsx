    ...
    <>
            ...
            <div className="row">
              ...
              <div className="row">
                <p className="hero-desc-ghost">
                  The information you’re about to share with the world
                  constitutes a great service to humanity. You can help people,
                  and make money simultaneously. Don’t hold your knowledge
                  hostage.
                </p>
              </div>
      ...
      <div class="container-fluid allghostservice">
        <h4 style={{ fontSize: "20px" }}>
          ...
          great content!<br /> We listen to digest your story, then package and
          present it in the best form to achieve a purpose. <br />You can grow your
          authority in your industry, turn your experiences into passive income,
          <br />curate your legacy, impact people’s lives, or do nothing…
        </h4>
        <a
          href="https://calendly.com/kalukalu/30min"
          target="_blank"
