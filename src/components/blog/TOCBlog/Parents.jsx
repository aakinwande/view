...
Light serves to expose or direct, depending on context and situation.
        ...
        will mean uncovering that which was previously hidden. <br /><br />
        The same multi-meaning can be read into a range of concepts and the most intriguing examples can 
        be found all over the human experience. <br /><br />
        People can interpret gifts as a show of condescension and an attempt at belittling their person. <br /><br />
        ...
        What that means is what you’re giving may not be what is being received. <br /><br />
        ...
        to light literally. <br /><br />
        You might have sent them spiraling into depression because with that light comes the reality that 
        they’re headed toward destruction. <br /><br />
        You mean well but on the receiving end, it’s perceived differently. <br /><br />
        How do you bridge the gap to ensure everyone is on the same page? <br /><br />
        Have you ever wondered why children think parents hate them when parents discipline them? 
        Parents only hope to correct a destructive habit but the kids receive a message of hatred. <br /><br />
