        ...
        <div class="row background-image-copy">
          <div className="col">
            <div className="row">
              ...
              We use words to paint pictures so your audience pays attention and money  

              </h5>
              <div className="row">
                <p className="hero-desc-copy">
                Your part is living to create the content our job is telling your story by articulating and putting 
out content that sticks with your audience 
                </p>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-8 pt-3">
                <div className="row">
                  ...
                  <p className="testimonial-desc">
                    {" "}
                    Owner of McFall Consulting Inc. Minneapolis, Minnesota, <br />
                    United States.
                  </p>
                </div>
              </div>
...
We compel sales for your business using the right words. The world rewards sensation before 
substance. Our words present your business as delivering something divine your customers 
can’t get elsewhere; they won’t just pay money, they’ll pay attention… you can multiply your 
business or remain where you are. 
          </p>
        </div>
        <div className="row">
          <a
